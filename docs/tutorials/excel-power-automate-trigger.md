...
本教程教你如何通过自动化的[ Power Automate ](https://flow.microsoft.com)工作流在 Web 上使用 Office Script for Excel。 每当你收到电子邮件时，脚本都会自动运行，并将电子邮件中的信息记录在 Excel 工作簿中。
...
> [!IMPORTANT]
> 本教程假定你已完成[在 Excel 网页版中运行 Office 脚本](excel-power-automate-manual.md)教程。
...
## <a name="create-an-office-script-for-your-automated-workflow"></a>为自动化工作流创建 Office 脚本
